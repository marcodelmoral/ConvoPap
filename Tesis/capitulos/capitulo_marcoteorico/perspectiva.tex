...
anormales e indicadores de cáncer, se llaman Displacias \index{Displacia} (del
...
% // TODO Hablar de el virus  del papiloma humano
...
\subsection{Epidemiología}
 % Como se manifiesta el cáncer a nivel internacional
...
(\hyperlink{abbr}{VPH}\nomenclature{VPH}{Virus del Papiloma Humano})
\index{Virus del Papiloma Humano} es el factor de riesgo más prominente, donde
