...
función \mintinline{latex}{tf.lite.TFLiteConverter.from_keras_model(model)} que
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\textwidth,angle=270,origin=c]{capitulo_sdac/impresora_resina}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{capitulo_sdac/kivy}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{capitulo_sdac/gui}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{capitulo_sdac/gui2}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\textwidth]{capitulo_sdac/prototipo_final}
