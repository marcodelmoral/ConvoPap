...
\begin{table}[H]
    ...
    \end{table}
\section{MobileNet}
El rendimiento de esta red se da en la~\autoref{fig:mobile_total}, donde se nota
la tendencia a mejorar del modelo conforme pasan las épocas, aunque lo hace muy
lentamente. La~\autoref{tabla:mobile} compila que la exactitud en validación se
estanca alrededor del 88\%, es probable que mayor entrenamiento mejore la
exactitud.
\begin{figure}[H]
    \centering
    \begin{subfigure}[b]{0.6\textwidth}
...
\begin{table}[H]
    ...
    \end{table}
\section{NASNetLarge}
La~\autoref{fig:naslarge_total} compila el rendimiento de esta red, excelente rendimiento
...
\begin{table}[H]
    ...
    \end{table}
\section{Xception}
Por último, tenemos una red cuyo rendimiento está compilado en la
Figura~\autoref{fig:excep_total}, su rendimiento comparado con las dos
arquitecturas anteriores fue mediocre. La Tabla~\autoref{tabla:xcep} muestra que
la red en lugar de mejorar, empeoró con el tiempo.
\begin{figure}[H]
    \centering
    \begin{subfigure}[b]{0.6\textwidth}
        \centering
