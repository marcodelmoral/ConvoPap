...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{0.8\textwidth}
        \centering
       \includegraphics[width=1\textwidth,height=7cm]{apendice_comparativa/DenseNet201/accuracy.pdf}
       \caption{Exactitud}\label{fig:accuracy_dense} 
    \end{subfigure}

    \begin{subfigure}[b]{0.8\textwidth}
        \centering
       \includegraphics[width=1\textwidth,height=7cm]{apendice_comparativa/DenseNet201/perdida.pdf}
...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{0.8\textwidth}
        \centering
       \includegraphics[width=1\textwidth,height=7cm]{apendice_comparativa/InceptionResNetV2/accuracy.pdf}
       \caption{Exactitud}\label{fig:accuracy_incepres} 
    \end{subfigure}
    \begin{subfigure}[b]{0.8\textwidth}
        \centering
       \includegraphics[width=1\textwidth,height=7cm]{apendice_comparativa/InceptionResNetV2/perdida.pdf}
...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{0.8\textwidth}
        \centering
       \includegraphics[width=1\textwidth,height=7cm]{apendice_comparativa/InceptionV3/accuracy.pdf}
       \caption{Exactitud}\label{fig:acc_v3} 
    \end{subfigure}
    \begin{subfigure}[b]{0.8\textwidth}
        \centering
       \includegraphics[width=1\textwidth,height=7cm]{apendice_comparativa/InceptionV3/perdida.pdf}
...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{0.8\textwidth}
        \centering
       \includegraphics[width=1\textwidth,height=7cm]{apendice_comparativa/MobileNet/accuracy.pdf}
       \caption{Exactitud}\label{fig:acc_mobile} 
    \end{subfigure}
    \begin{subfigure}[b]{0.8\textwidth}
        \centering
       \includegraphics[width=1\textwidth,height=7cm]{apendice_comparativa/MobileNet/perdida.pdf}
...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{0.8\textwidth}
        \centering
       \includegraphics[width=1\textwidth,height=7cm]{apendice_comparativa/MobileNetV2/accuracy.pdf}
       \caption{Exactitud}\label{fig:acc_mobilev2} 
    \end{subfigure}
    \begin{subfigure}[b]{0.8\textwidth}
        \centering
       \includegraphics[width=1\textwidth,height=7cm]{apendice_comparativa/MobileNetV2/perdida.pdf}
...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{0.8\textwidth}
        \centering
       \includegraphics[width=1\textwidth,height=7cm]{apendice_comparativa/NASNetLarge/accuracy.pdf}
       \caption{Exactitud}\label{fig:acc_nasnetlarge} 
    \end{subfigure}
    \begin{subfigure}[b]{0.8\textwidth}
        \centering
       \includegraphics[width=1\textwidth,height=7cm]{apendice_comparativa/NASNetLarge/perdida.pdf}
...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{0.8\textwidth}
        \centering
       \includegraphics[width=1\textwidth,height=7cm]{apendice_comparativa/NASNetMobile/accuracy.pdf}
       \caption{Exactitud}\label{fig:acc_nasmobile} 
    \end{subfigure}
    \begin{subfigure}[b]{0.8\textwidth}
        \centering
       \includegraphics[width=1\textwidth,height=7cm]{apendice_comparativa/NASNetMobile/perdida.pdf}
...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{0.8\textwidth}
        \centering
       \includegraphics[width=1\textwidth,height=7cm]{apendice_comparativa/ResNet50/accuracy.pdf}
       \caption{Exactitud}\label{fig:acc_resnet} 
    \end{subfigure}

    \begin{subfigure}[b]{0.8\textwidth}
        \centering
       \includegraphics[width=1\textwidth,height=7cm]{apendice_comparativa/ResNet50/perdida.pdf}
       \caption{Pérdida}\label{fig:loss_resnet}
    \end{subfigure}
    \caption{Gráfica de resultados ResNet50}
    \label{fig:resnet_total}
\end{figure}
\begin{table}[H]
    \centering
    \resizebox{\textwidth}{!}{%
...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{0.8\textwidth}
        \centering
       \includegraphics[width=1\textwidth,height=7cm]{apendice_comparativa/VGG16/accuracy.pdf}
       \caption{Exactitud}\label{fig:acc_vgg16} 
    \end{subfigure}
    \begin{subfigure}[b]{0.8\textwidth}
        \centering
       \includegraphics[width=1\textwidth,height=7cm]{apendice_comparativa/VGG16/perdida.pdf}
...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{0.8\textwidth}
        \centering
       \includegraphics[width=1\textwidth,height=7cm]{apendice_comparativa/VGG19/accuracy.pdf}
       \caption{Exactitud}\label{fig:vgg19_acc} 
    \end{subfigure}

    \begin{subfigure}[b]{0.8\textwidth}
        \centering
       \includegraphics[width=1\textwidth,height=7cm]{apendice_comparativa/VGG19/perdida.pdf}
...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{0.8\textwidth}
        \centering
       \includegraphics[width=1\textwidth,height=7cm]{apendice_comparativa/Xception/accuracy.pdf}
       \caption{Exactitud}\label{fig:xcep_acc} 
    \end{subfigure}
    \begin{subfigure}[b]{0.8\textwidth}
        \centering
       \includegraphics[width=1\textwidth,height=7cm]{apendice_comparativa/Xception/perdida.pdf}
